# Historical build-off notes

Archived from the original README on 2026-09-14. This is historical project context, not the current setup guide or a current verification report. Counts and implementation details below may be outdated; start with the [current README](../../README.md).
